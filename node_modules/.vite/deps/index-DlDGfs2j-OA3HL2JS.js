import {
  ...
  tQ,
  yr
} from "./chunk-F5PCZ7YX.js";
import "./chunk-DC5AMYBS.js";

// node_modules/@strudel/repl/dist/index-DlDGfs2j.js
var N = class _N {
  /**
   ...
   */
  constructor(e = false) {
    this.eventMap = {}, this.eventsSuspended = e == true;
  }
  /**
   ...
   */
  addListener(e, t, n = {}) {
    if (typeof e == "string" && e.length < 1 || e instanceof String && e.length < 1 || typeof e != "string" && !(e instanceof String) && e !== _N.ANY_EVENT)
   ...
   */
  hasListener(e, t) {
    return e === void 0 ? this.eventMap[_N.ANY_EVENT] && this.eventMap[_N.ANY_EVENT].length > 0 ? true : Object.entries(this.eventMap).some(([, n]) => n.length > 0) : this.eventMap[e] && this.eventMap[e].length > 0 ? t instanceof Z ? this.eventMap[e].filter((r) => r === t).length > 0 : typeof t == "function" ? this.eventMap[e].filter((r) => r.callback === t).length > 0 : t == null : false;
  }
  /**
  ...
  emit(e, ...t) {
    ...
    let n = [], r = this.eventMap[_N.ANY_EVENT] || [];
...
var Z = class {
  ...
  constructor(e, t, n, r = {}) {
    ...
    r.arguments !== void 0 && !Array.isArray(r.arguments) && (r.arguments = [r.arguments]), r = Object.assign({
      ...
      arguments: void 0,
      duration: 1 / 0
    }, r), r.duration !== 1 / 0 && setTimeout(() => this.remove(), r.duration), this.arguments = r.arguments, this.callback = n, this.context = r.context, this.count = 0, this.event = e, this.remaining = parseInt(r.remaining) >= 1 ? parseInt(r.remaining) : 1 / 0, this.suspended = false, this.target = t;
  }
  /**
...
var o = class {
  ...
  static toTimestamp(e) {
    ...
    return isNaN(n) ? false : (typeof e == "string" && e.substring(0, 1) === "+" ? n >= 0 && (t = l.time + n) : n >= 0 && (t = n), t);
  }
  /**
  ...
  sendRpnDecrement(e, t = {}) {
    if (Array.isArray(e) || (e = a.REGISTERED_PARAMETERS[e]), l.validation) {
      ...
      if (Object.getOwnPropertyNames(a.REGISTERED_PARAMETERS).forEach((r) => {
        a.REGISTERED_PARAMETERS[r][0] === e[0] && a.REGISTERED_PARAMETERS[r][1] === e[1] && (n = true);
...
var Y = class {
  ...
  constructor(e = [], t = {}) {
    ...
    ], this.channels = a.MIDI_CHANNEL_NUMBERS, this.suspended = false, Array.isArray(e) || (e = [e]), t.types && !Array.isArray(t.types) && (t.types = [t.types]), t.channels && !Array.isArray(t.channels) && (t.channels = [t.channels]), l.validation && (e.forEach((n) => {
      if (!(n instanceof P))
...
var oe = class extends N {
   ...
   */
  constructor(e, t) {
    super(), this._input = e, this._number = t, this._octaveOffset = 0, this._nrpnBuffer = [], this._rpnBuffer = [], this.parameterNumberEventsEnabled = true, this.notesState = new Array(128).fill(false);
  }
  /**
  ...
  _parseEventForStandardMessages(e) {
    ...
    if (t.type === "noteoff" || t.type === "noteon" && r === 0)
      this.notesState[n] = false, t.type = "noteoff", t.note = new y(
        o.offsetNumber(
          n,
      ...
      this.notesState[n] = true, t.note = new y(
        o.offsetNumber(
          n,
          this.octaveOffset + this.input.octaveOffset + l.octaveOffset
        ),
  ...
  _parseChannelModeMessage(e) {
    const t = Object.assign({}, e);
    t.type = t.controller.name, t.type === "localcontrol" && (t.value = t.message.data[2] === 127, t.rawValue = t.message.data[2]), t.type === "omnimodeon" ? (t.type = "omnimode", t.value = true, t.rawValue = t.message.data[2]) : t.type === "omnimodeoff" && (t.type = "omnimode", t.value = false, t.rawValue = t.message.data[2]), t.type === "monomodeon" ? (t.type = "monomode", t.value = true, t.rawValue = t.message.data[2]) : t.type === "polymodeon" && (t.type = "monomode", t.value = false, t.rawValue = t.message.data[2]), this.emit(t.type, t);
  }
  /**
...
var le = class extends N {
   ...
   */
  get nrpnEventsEnabled() {
    return l.validation && console.warn("The 'nrpnEventsEnabled' property has been moved to the 'InputChannel' class."), false;
  }
};
var ge = class extends N {
  ...
  async enable(e = {}, t = false) {
    ...
    if (this.validation = e.validation !== false, this.validation && (typeof e == "function" && (e = { callback: e, sysex: t }), t && (e.sysex = true)), this.enabled)
   ...
   * @since 2.0.0
   */
  getInputById(e, t = { disconnected: false }) {
    if (this.validation) {
   ...
   * @since 2.0.0
   */
  getInputByName(e, t = { disconnected: false }) {
    if (this.validation) {
      if (!this.enabled) throw new Error("WebMidi is not enabled.");
      if (!e) return;
      e = e.toString();
   ...
   * @since 2.0.0
   */
  getOutputByName(e, t = { disconnected: false }) {
    if (this.validation) {
      if (!this.enabled) throw new Error("WebMidi is not enabled.");
      if (!e) return;
      e = e.toString();
   ...
   * @since 2.0.0
   */
  getOutputById(e, t = { disconnected: false }) {
    if (this.validation) {
      if (!this.enabled) throw new Error("WebMidi is not enabled.");
      if (!e) return;
    }
   ...
   */
  getOctave(e) {
    return this.validation && (console.warn("The getOctave()is deprecated. Use Utilities.getNoteDetails() instead"), e = parseInt(e)), !isNaN(e) && e >= 0 && e <= 127 ? o.getNoteDetails(o.offsetNumber(e, this.octaveOffset)).octave : false;
  }
  /**
   * @private
  ...
  _onInterfaceStateChange(e) {
    ...
    if (e.port.state === "connected" && e.port.connection === "open") {
      ...
      e.port.type === "input" ? t.port = this.getInputById(e.port.id, { disconnected: true }) : e.port.type === "output" && (t.port = this.getOutputById(e.port.id, { disconnected: true })), this.emit(e.port.state, t);
      const n = Object.assign({}, t);
      n.type = "portschanged", this.emit(n.type, n);
    }
  }
...
typeof window < "u" && window.addEventListener("message", (i) => {
  (f == null ? void 0 : f.enabled) && i.data === "strudel-stop" && f.outputs.forEach((e) => e.sendStop());
});
var T = /* @__PURE__ */ new Map();
function de(i) {
  return Object.fromEntries(
    Object.entries(i).map(([e, t]) => (typeof t == "number" && (t = { ccn: t }), [Fl(e), t]))
  );
}
function we(i, e = "") {
...
function Se(i, e) {
  return Object.keys(e).filter((t) => !!i[Fl(t)]).map((t) => {
...
function Ce(i, e, t, n, r, s) {
  ...
  const c = typeof i == "number" ? i : yr(i), d = new y(c, { attack: e, duration: t });
  tQ(() => {
    n.playNote(d, r);
  }, s);
}
fe.prototype.midi = function(i, e = {}) {
  var _a, _b;
  if (Hd(i))
    throw new Error(
      `.midi does not accept Pattern input for midiport. Make sure to pass device name with single quotes. Example: .midi('${((_b = (_a = f.outputs) == null ? void 0 : _a[0]) == null ? void 0 : _b.name) || "IAC Driver Bus 1"}')`
    );
  if (typeof i == "object") {
    const { port: n, isController: r = false, ...s } = i;
    e = {
      isController: r,
      ...s,
      ...e
  ...
  return ce({
    onEnabled: ({ outputs: n }) => {
      ...
      kn(
        `Midi enabled! Using "${r.name}". ${(s == null ? void 0 : s.length) ? `Also available: ${v(s)}` : ""}`
      );
    },
    onDisconnected: ({ outputs: n }) => kn(`Midi device disconnected! Available: ${v(n)}`)
    ...
    if (S = O * S, T.has(B) ? Se(T.get(B), n.value).forEach(({ ccn: H, ccv: k }) => z(H, k, u, m, c)) : B !== "default" && kn(`[midi] midimap "${B}" not found! Available maps: ${[...T.keys()].join(", ")}`), d !== void 0 && !t.isController) {
      const R = n.duration.valueOf() / s * 1e3 - t.noteOffsetMs;
      Ce(d, S, R, u, m, c);
    }
    if (M !== void 0 && J(M, u, m, c), G !== void 0 && q !== void 0 && ee(G, q, u, c), p !== void 0 && g !== void 0 && z(g, p, u, m, c), E !== void 0 && w !== void 0 && Me(E, w, u, m, c), _ !== void 0 && Ae(_, u, m, c), C !== void 0 && Ie(C, u, m, c), n.whole.begin + 0 === 0 && tQ(() => {
      u.sendStart();
...
async function he(i) {
  ...
  if (Hd(i))
    throw new Error(
      `[midi] Midi input cannot be a pattern. Make sure to pass device name with single quotes. Example: midin('${((_b = (_a = f.outputs) == null ? void 0 : _a[0]) == null ? void 0 : _b.name) || "IAC Driver Bus 1"}')`
    );
  ...
  if (e) {
    ...
    kn(
      `[midi] Midi enabled! Using "${t.name}". ${(n == null ? void 0 : n.length) ? `Also available: ${v(n)}` : ""}`
    );
  }
  return t;
}
...
function Re(i, e, t, n) {
  ...
  if (!r || !s)
    return false;
  const c = t + n, d = 1e-6, w = r.queryArc(c - d, c + d, { _cps: e }).filter((p) => {
    var _a, _b;
    return (_b = (_a = p.value) == null ? void 0 : _a.midikey) == null ? void 0 : _b.startsWith(`${i}_`);
  }), g = st().currentTime;
...
async function Le(i) {
  ...
  return A[i] || (A[i] = []), L[i] && e.removeListener("midimessage", L[i]), L[i] = (n) => {
    ...
    const [g, p] = r;
    d || (d = c && p === 0);
    const m = `${i}_${g}`, h = CT() ?? 0.5, _ = !!(MT() && ST()), C = _ ? 0.01 : 0.06, x = Sm(), O = x + C * h, S = new cn(O, O);
    let M = { midikey: m };
    d || (M = { ...M, note: Math.round(g), velocity: p / 127 }, A[i].push(new en(S, S, M, {})), !d && _ && Re(i, h, x, C * h) && (A[i] = []));
  }, e.addListener("midimessage", L[i]), (n = 0.5) => {
    const r = be(n), s = (c) => {
      const d = A[i].flatMap((E) => r.query(c.setSpan(E.wholeOrPart())).map((g) => {
        const p = g.value ?? 0.5, m = new cn(E.whole.begin, E.whole.begin.add(p)), h = new cn(E.part.begin, E.part.begin.add(p)), _ = E.combineContext(g);
        return new en(m, h, E.value, _);
      }));
...
@strudel/repl/dist/index-DlDGfs2j.js:
  (**
   ...
   *)
*/
//# sourceMappingURL=index-DlDGfs2j-OA3HL2JS.js.map
