...
var kl = (e) => {
  ...
  if (typeof e != "string")
    return [];
  const [t, n = "", s] = ((_a2 = e.match(/^([a-gA-G])([#bsf]*)(-?[0-9]*)$/)) == null ? void 0 : _a2.slice(1)) || [];
  return t ? [t, n, s ? Number(s) : void 0] : [];
};
var C9 = { c: 0, d: 2, e: 4, f: 5, g: 7, a: 9, b: 11 };
var x9 = { "#": 1, b: -1, s: 1, f: -1 };
var gu = (e) => (e == null ? void 0 : e.split("").reduce((t, n) => t + x9[n], 0)) || 0;
var yn = (e, t = 3) => {
  const [n, s, i = t] = kl(e);
  if (!n)
...
var et = class _et {
  ...
  get duration() {
    var _a2, _b2;
    let t;
    return typeof ((_a2 = this.value) == null ? void 0 : _a2.duration) == "number" ? t = U(this.value.duration) : t = this.whole.end.sub(this.whole.begin), typeof ((_b2 = this.value) == null ? void 0 : _b2.clip) == "number" ? t.mul(this.value.clip) : t;
  }
  get endClipped() {
  ...
  hasTag(t) {
    var _a2;
    return (_a2 = this.context.tags) == null ? void 0 : _a2.includes(t);
  }
  resolveState(t) {
...
function K9(e, t, n) {
  if ((t == null ? void 0 : t.value) !== void 0 && Object.keys(t).length === 1)
  ...
  onTrigger(t, n = true) {
    return this.withHap(
      (s) => s.setContext({
        ...
        onTrigger: (...i) => {
          var _a2, _b2;
          (_b2 = (_a2 = s.context).onTrigger) == null ? void 0 : _b2.call(_a2, ...i), t(...i);
        },
...
function Pu(e) {
  return e instanceof _ || (e == null ? void 0 : e._Pattern);
}
function j(e) {
...
function Fu(...e) {
  ...
  const t = function(n) {
    ...
    return ((_a2 = e[s]) == null ? void 0 : _a2.query(n)) || [];
  };
...
var gG = B("zoom", function(e, t, n) {
  ...
  if (t = U(t), e = U(e), e.gte(t))
    return Wt;
  const s = t.sub(e), i = Tt ? (_a2 = n._steps) == null ? void 0 : _a2.mulmaybe(s) : void 0;
...
_.prototype.modulate = function(e, t, n) {
  ...
  for (const [a, u] of Object.entries(t)) {
    ...
    i = i.fmap(({ v: l, id: p }) => (m) => {
      ...
      l[e] ?? (l[e] = { __ids: /* @__PURE__ */ new Set() });
      const g = l[e];
      return p ?? (p = g.__ids.size), g[p] ?? (g[p] = { control: r }), g.__ids.add(p), m === void 0 ? { v: l, id: p } : (o === "control" || o === "subControl" ? g[p][o] = xi(m) : g[p][o] = m, { v: l, id: p });
    }).appLeft(c);
  }
  return i.fmap(({ v: a }) => a);
};
...
var Db = class {
        ...
        try {
          ...
          this.pattern.queryArc(v, E, { _cps: this.cps, cyclist: "cyclist" }).forEach((V) => {
            if (V.hasOnset()) {
              ...
              n == null ? void 0 : n(V, Z, X, this.cps, D), V.value.cps !== void 0 && this.cps != V.value.cps && (this.cps = V.value.cps, this.num_ticks_since_cps_change = 0);
            }
          });
        } catch (v) {
          Si(v), i == null ? void 0 : i(v);
        }
      },
      t,
  ...
  setStarted(t) {
    var _a2;
    this.started = t, (_a2 = this.onToggle) == null ? void 0 : _a2.call(this, t);
  }
  async start() {
    var _a2;
...
var wP = class {
    ...
    const i = (a) => {
      ...
      this.pattern.queryArc(a, u, { _cps: this.cps, cyclist: "neocyclist" }).forEach((l) => {
        if (l.hasOnset()) {
          ...
          t == null ? void 0 : t(l, 0, g, this.cps, m);
        }
      });
    };
  ...
  setStarted(t) {
    var _a2;
    this.sendMessage("toggle", { started: t }), this.started = t, (_a2 = this.onToggle) == null ? void 0 : _a2.call(this, t);
  }
  start() {
...
function BP(e, t) {
  var _a2;
  const n = Pt.get(e);
  return ((_a2 = n == null ? void 0 : n.ins) == null ? void 0 : _a2[t]) ? n.ins[t].name : "";
}
  ...
  return bt(
    ...
    (...s) => {
      ...
      return s = s.map(
        (r, a) => {
          var _a3, _b3;
          return (_b3 = (_a3 = Ee.parseInput(r)).asModuleInput) == null ? void 0 : _b3.call(_a3, e, i, a);
        }
      ), (_b2 = (_a2 = t(...s)).asModuleOutput) == null ? void 0 : _b2.call(_a2, e, i);
    },
    n
  );
}
...
var yA = class {
  ...
  async init() {
    var _a2;
    if (!this.audioCtx) {
      if (_a(!this.audioCtx), this.audioCtx = ((_a2 = this.outputNode) == null ? void 0 : _a2.context) || new AudioContext({
  ...
  destroy() {
    var _a2, _b2, _c2;
    (_a2 = this.audioWorklet) == null ? void 0 : _a2.disconnect(), this.audioWorklet = null, (_b2 = this.recorder) == null ? void 0 : _b2.disconnect(), this.recorder = null, !this.outputNode && ((_c2 = this.audioCtx) == null ? void 0 : _c2.close()), this.audioCtx = null;
  }
  /**
   * Stop audio playback
   */
  stop() {
    var _a2;
    this.audioCtx && this.send({ type: "STOP" }), (_a2 = this.mouse) == null ? void 0 : _a2.detach();
  }
  record() {
    if (!this.audioCtx) {
...
var XX = class {
  ...
  evaluate(t) {
    ...
    let n;
    this.transpiler ? n = this.transpiler(t) : n = { output: t }, (_a2 = this.beforeEval) == null ? void 0 : _a2.call(this, n);
    let s;
  ...
  async play(t) {
    var _a2;
    await this.audio.init(), t.ins.length && this.audio.spawn(t), (_a2 = this.onToggle) == null ? void 0 : _a2.call(this, true);
  }
  run(t) {
  ...
  stop() {
    var _a2;
    this.stopRecording(), this.audio.stop(), (_a2 = this.onToggle) == null ? void 0 : _a2.call(this, false);
  }
  record() {
    var _a2;
    this.audio.record(), (_a2 = this.onToggleRecording) == null ? void 0 : _a2.call(this, true);
  }
  stopRecording() {
    var _a2;
    this.audio.stopRecording(), (_a2 = this.onToggleRecording) == null ? void 0 : _a2.call(this, false);
  }
};
function DX({
  defaultOutput: e,
  ...
  const x = new XX({ localScope: true }), v = {
    ...
    Object.assign(v, he), v.isDirty = v.code !== v.activeCode, v.error = v.evalError || v.schedulerError, c == null ? void 0 : c(v);
  }, V = {
    onTrigger: s2({ defaultOutput: e, getTime: r }),
    getTime: r,
    onToggle: (he) => {
      w({ started: he }), Wb(he), u == null ? void 0 : u(he), he || Sb();
    },
    setInterval: p,
    clearInterval: m,
    beforeStart: s
  ...
  const $ = async (he, Ge = true) => (he = (o == null ? void 0 : o(he)) || he, await D.setPattern(he, Ge), zb(he), he);
  ar(() => D.now());
  ...
  return { scheduler: D, evaluate: async (he, Ge = true, Ce = true) => {
    ...
    try {
      w({ code: he, pending: true }), await dt(), ar(() => D.now()), await (n == null ? void 0 : n({ code: he })), se = [], Ce && R(), y && (he = `mondolang\`${he}\``);
      ...
      return Pu(Pe) || (Pe = Ye), gt("[eval] code updated"), Pe = await $(Pe, Ge), w({
        miniLocations: (Se == null ? void 0 : Se.miniLocations) || [],
        widgets: (Se == null ? void 0 : Se.widgets) || [],
        activeCode: he,
        pattern: Pe,
        evalError: void 0,
        schedulerError: void 0,
        pending: false
      }), i == null ? void 0 : i({ code: he, pattern: Pe, meta: Se }), Pe;
    } catch (Pe) {
      gt(`[eval] error: ${Pe.message}`, "error"), console.error(Pe), w({ evalError: Pe, pending: false }), t == null ? void 0 : t(Pe);
    }
...
var ur;
try {
  ur = window == null ? void 0 : window.speechSynthesis;
} catch {
  console.warn("cannot use window: not in browser?");
}
var bc = ur == null ? void 0 : ur.getVoices();
function kD(e, t, n) {
  ur.cancel();
...
function ID(e, t, n) {
  ...
  return bn(s.node, () => {
    ...
    node: i.node,
    stop: (r) => s == null ? void 0 : s.stop(r),
    teardown: i.teardown
  };
}
var Ua = /* @__PURE__ */ new Map();
var Ju = Symbol("nodePoolKey");
var _D = (e) => !!e[Ju];
var P2 = (e) => {
  var _a2;
  return ((_a2 = e.context) == null ? void 0 : _a2.currentTime) ?? 0;
};
var YD = (e) => {
  var _a2;
  const t = /* @__PURE__ */ new Set();
  (_a2 = e.parameters) == null ? void 0 : _a2.forEach((i) => t.add(i));
...
var HD = (e) => {
  ...
  const t = P2(e), n = ((_a2 = e == null ? void 0 : e.parameters) == null ? void 0 : _a2.get("end").value) ?? 0;
  return t < n + 0.45;
};
var Ei = (e, t) => {
  var _a2;
  ...
  let s, i = false;
  for (; n.length; )
    if (s = (_a2 = n.pop()) == null ? void 0 : _a2.deref(), s != null && HD(s)) {
      i = true;
      break;
    }
...
var OD = (e) => (e == null ? void 0 : e.split("").reduce((t, n) => t + UD[n], 0)) || 0;
var Fr = (e, t = 3) => {
  const [n, s, i = t] = KD(e);
  if (!n)
    throw new Error('not a note: "' + e + '"');
...
function Fi(e, t, n) {
  ...
  return {
    nodes: a,
    stop: (u) => i.forEach((o) => o == null ? void 0 : o.stop(u))
  };
}
var L2 = (e) => e / (1 + e);
var sS = (e, t) => (e % t + t) % t;
...
var Re = (e) => {
  ...
  if (e != null) {
    ...
    e instanceof AudioWorkletNode && ((_a2 = e.parameters.get("end")) == null ? void 0 : _a2.setValueAtTime(0, 0));
  }
};
var k2 = (e, t) => {
...
var MS = (e, t) => {
  if (e == null ? void 0 : e.parameters) {
    const s = e.parameters.get(t);
    if (s instanceof AudioParam)
      return s;
  }
  let n = e == null ? void 0 : e[t];
  if (n === void 0 && t === "frequency" && (n = (e == null ? void 0 : e.detune) ?? (e == null ? void 0 : e.playbackRate)), n instanceof AudioParam)
    return n;
};
var Pc = bS();
var CS = (e, t) => {
...
async function J2(e, t, n, s, i) {
  ...
  R.connect(z), bn(w, function() {
    Re(w), X == null ? void 0 : X.stop(), Re(R), Re(z), n();
  });
  let $ = H + E + 0.01;
  w.stop($);
  const I = (ee) => {
    w.stop(ee);
  }, Y = { node: z, nodes: { source: [w], ...X == null ? void 0 : X.nodes }, stop: I };
  if (u !== void 0) {
    const ee = Ac[u];
...
var SS = class {
  ...
  disconnect() {
    var _a2, _b2;
    this.output.disconnect(), this.summingNode.disconnect(), (_a2 = this.delayNode) == null ? void 0 : _a2.disconnect(), (_b2 = this.reverbNode) == null ? void 0 : _b2.disconnect();
  }
  getDjf(t, n = 0) {
  ...
  getDelay(t = 0, n = 0.5, s) {
    var _a2, _b2;
    return n = gn(n, 0, 0.98), this.delayNode == null && (this.delayNode = this.audioContext.createFeedbackDelay(1, t, n), this.delayNode.connect(this.summingNode), (_b2 = (_a2 = this.delayNode).start) == null ? void 0 : _b2.call(_a2, s)), this.delayNode.delayTime.value !== t && this.delayNode.delayTime.setValueAtTime(t, s), this.delayNode.feedback.value !== n && this.delayNode.feedback.setValueAtTime(n, s), this.delayNode;
  }
...
var wS = class {
  constructor(t) {
    ...
    __publicField(this, "connectToDestination", (t, n = [0, 1]) => {
...
function ro(e, t, n) {
  sn(
    e,
    (s, i, r, a) => tM(s, i, r, t, a, (n == null ? void 0 : n.frameLen) ?? 2048),
    {
      type: "wavetable",
      tables: t,
      ...n
...
async function tM(e, t, n, s, i, r) {
  ...
  const at = {
    ...
    nodes: {
      ...
      wt_lfo: [re],
      warp_lfo: [se],
      ...rt == null ? void 0 : rt.nodes,
      ...Ie == null ? void 0 : Ie.nodes
    }
  }, he = mn(
    l,
    () => {
      Qu(H), Ie == null ? void 0 : Ie.stop(), rt == null ? void 0 : rt.stop(), Re(re), Re(se), n();
    },
    e,
    Z
  );
...
function Dr(e = "time", t = 1) {
  const n = {
    time: () => {
      var _a2;
      return (_a2 = vt[t]) == null ? void 0 : _a2.getFloatTimeDomainData(us[t]);
    },
    frequency: () => {
      var _a2;
      return (_a2 = vt[t]) == null ? void 0 : _a2.getFloatFrequencyData(us[t]);
    }
  }[e];
  if (!n)
...
var Sr = async (e, t, n, s = 0.5, i = 0.5) => {
  ...
  for (let ie = 0; ie <= si.size - uo; ie++) {
    ...
    (_b2 = (_a2 = He == null ? void 0 : He.node) == null ? void 0 : _a2.gain) == null ? void 0 : _b2.linearRampToValueAtTime(0, Te), (_c2 = He == null ? void 0 : He.stop) == null ? void 0 : _c2.call(He, Te), si.delete(pe);
  }
  if (["-", "~", "_"].includes(c))
    return;
  l && c && (c = `${l}_${c}`, e.s = c);
  ...
  [...QS].forEach((e) => {
    ...
    (e, t, n) => {
      ...
      let H = mn(
        s,
        () => {
          Qu(D), n(), L == null ? void 0 : L.stop(), Z == null ? void 0 : Z.stop();
        },
        e,
        x
      );
      return {
        node: R,
        nodes: { source: [D], ...L == null ? void 0 : L.nodes, ...Z == null ? void 0 : Z.nodes },
        stop: (z) => {
          H.stop(z);
        }
      };
    ...
    (e, t, n) => {
      ...
      let D = mn(
        s,
        () => {
          Re(x), Re(V), n(), E == null ? void 0 : E.stop(), v == null ? void 0 : v.stop();
        },
        e,
        y
      );
      return {
        node: w,
        nodes: { source: [x], pw_lfo: [V], ...E == null ? void 0 : E.nodes, ...v == null ? void 0 : v.nodes },
        stop: (X) => {
          D.stop(X);
        }
      };
...
function fM(e, t, n) {
  ...
  for (let p = 0; p < i; p++) {
    const m = e[p], [g, y] = c[n](p + 1), x = (t == null ? void 0 : t[p]) ?? 0;
    let v = g * m, E = y * m;
    if (x !== 0) {
...
function yM(e, t, n, s) {
  ...
  if (e === "user" && !a && (lt(
    ...
    return u = new ConstantSourceNode(ve(), { offset: 1 }), u.start(t), {
      node: u,
      nodes: { source: u },
      stop: (p) => u == null ? void 0 : u.stop(p)
    };
  !a || (a == null ? void 0 : a.length) === 0 || e === "sine" ? (u = ve().createOscillator(), u.type = e || "triangle") : u = fM(a, n.phases, e), u.frequency.value = Kn(n);
  const o = Vs(u.detune, n, t);
  Bs(u.detune, n, t, t + i);
  const c = Fi(u.frequency, n, t);
  let l;
  return r && (l = ID(u, r, t)), bn(u, () => {
    l == null ? void 0 : l.teardown(), Re(u), Re(l == null ? void 0 : l.node), s();
  }), u.start(t), {
    node: (l == null ? void 0 : l.node) || u,
    nodes: { source: [u], ...o == null ? void 0 : o.nodes, ...c == null ? void 0 : c.nodes },
    stop: (p) => {
      c.stop(p), o == null ? void 0 : o.stop(p), l == null ? void 0 : l.stop(p), u.stop(p);
    },
    triggerRelease: (p) => {
    }
  };
...
function ew(e = 1, t = 0.05, n = 220, s = 0, i = 0, r = 0.1, a = 0, u = 1, o = 0, c = 0, l = 0, p = 0, m = 0, g = 0, y = 0, x = 0, v = 0, E = 1, w = 0, V = 0) {
  ...
  for (s = s * X + 9, w *= X, i *= X, r *= X, v *= X, c *= 500 * D / X ** 3, y *= D / X, l *= D / X, p *= X, m = m * X | 0, se = s + w + i + r + v | 0; I < se; H[I++] = re)
    ...
    Math.cos(y * $++), z += de - de * g * (1 - (Math.sin(I) + 1) * 1e9 % 2), Y && ++Y > p && (n += l, R += l, Y = 0), m && !(++ee % m) && (n = R, o = L, Y || (Y = 1));
  return H;
}
var gM = (e, t) => {
  let {
...
var MM = () => {
  var _a2;
  ws && (ws == null ? void 0 : ws.stop(), (_a2 = ws == null ? void 0 : ws.node) == null ? void 0 : _a2.disconnect());
};
typeof window < "u" && window.addEventListener("message", (e) => {
  var _a2;
  e.data === "strudel-stop" ? MM() : ((_a2 = e.data) == null ? void 0 : _a2.dough) && (ws == null ? void 0 : ws.node.port.postMessage(e.data));
});
var nw = async (e) => {
  const t = ve();
...
var vM = (e, t, n, s, i) => {
  var _a2;
  return Sr(GM(e), i, n, s, (_a2 = e.whole) == null ? void 0 : _a2.begin.valueOf());
};
    ...
    if (l.hasOnset())
      try {
        await Sr(
          ...
          l.duration / t,
          t,
          (((_a2 = l.whole) == null ? void 0 : _a2.begin.valueOf()) - n) / t
        );
      } catch (p) {
        Pi(p, "webaudio");
      }
...
function FM({
  ...
  y && (m = he, g = Ge, dt = g - m + 1), at = Ce.sort(
    ...
    if (L && !Le)
      return;
    let We = (_a2 = Se.value) == null ? void 0 : _a2.color;
...
function Gw(e) {
  ...
  E.forEach((I) => {
    var _a2;
    const Y = I.whole.begin <= v && I.endClipped > v, ee = I.whole.begin - v + r, Me = I.endClipped - v + r - c, re = ((_a2 = I.value) == null ? void 0 : _a2.color) || p, de = g || Y ? re : m, se = y ? 1 - Math.abs((I.whole.begin - v) / z) : 1;
    Lc({
      ctx: x,
      ...R,
      from: ee,
...
_.prototype.tscope = function(e = {}) {
  ...
  return this.analyze(t).draw(
    (n) => {
      var _a2, _b2;
      e.color = ((_b2 = (_a2 = n[0]) == null ? void 0 : _a2.value) == null ? void 0 : _b2.color) || Rn().foreground, e.color, SM(e.smear, "0,0,0", e.ctx), XM(vt[t], e);
    },
    { id: t }
  );
};
...
_.prototype.spectrum = function(e = {}) {
  ...
  return this.analyze(t).draw(
    (n) => {
      var _a2, _b2;
      e.color = ((_b2 = (_a2 = n[0]) == null ? void 0 : _a2.value) == null ? void 0 : _b2.color) || Vc[t] || Rn().foreground, Vc[t] = e.color, Aw(vt[t], e);
    },
    { id: t }
  );
};
...
var Sw = (e, t) => (n, s) => {
  var _a2;
  const a = (_a2 = e.source_[s].options_) == null ? void 0 : _a2.ops, u = n.__steps_source;
  if (a)
    for (const o of a)
      switch (o.type_) {
        case "stretch": {
    ...
    case "pattern": {
      ...
      switch (a) {
        ...
        default: {
          if (e.source_.some((l) => {
            var _a2;
            return !!((_a2 = l.options_) == null ? void 0 : _a2.weight);
          })) {
            const l = e.source_.reduce(
              (p, m) => {
                var _a2;
                return p.add(((_a2 = m.options_) == null ? void 0 : _a2.weight) || U(1));
              },
              U(0)
            );
            o = Su(
              ...e.source_.map((p, m) => {
                var _a2;
                return [((_a2 = p.options_) == null ? void 0 : _a2.weight) || U(1), r[m]];
              })
...
var po = (e, t, n = 0) => {
  const { start: s, end: i } = t.location_, r = e == null ? void 0 : e.split("").slice(s.offset, i.offset).join(""), [a = 0, u = 0] = r ? r.split(t.source_).map((o) => o.split("").filter((c) => c === " ").length) : [];
...
function $Z(e, t = {}) {
    ...
    enter(y, x) {
      ...
      if (l7(y))
        return r && p.push({
          ...
          // don't use value!
          min: ((_a3 = y.arguments[1]) == null ? void 0 : _a3.value) ?? 0,
          max: ((_b2 = y.arguments[2]) == null ? void 0 : _b2.value) ?? 1,
          step: (_c2 = y.arguments[3]) == null ? void 0 : _c2.value,
          type: "slider"
        }), this.replace(h7(y));
      if (d7(y)) {
  ...
  else if (!((_a2 = m == null ? void 0 : m[m.length - 1]) == null ? void 0 : _a2.expression))
...
function e7(e) {
  ...
  let t = e.callee;
  return t.type === "ChainExpression" && (t = t.expression), t.type === "MemberExpression" ? !t.computed && ((_a2 = t.property) == null ? void 0 : _a2.name) === "K" : t.type === "Identifier" && t.name === "K";
}
function t7(e) {
  var _a2;
  return e.type !== "ArrowFunctionExpression" && e.type !== "FunctionExpression" || e.params.length ? false : ((_a2 = e.body) == null ? void 0 : _a2.type) === "BlockStatement";
}
function uu(e) {
...
function s7(e) {
  var _a2;
  if (i7(e)) {
    const t = (_a2 = e.arguments) == null ? void 0 : _a2[0];
    if (!t)
...
function i7(e) {
  ...
  if (e.type !== "CallExpression")
    return false;
  const t = e.callee;
  return t.type === "Identifier" ? t.name === "S" : t.type === "MemberExpression" && !t.computed ? ((_a2 = t.property) == null ? void 0 : _a2.name) === "S" : false;
}
function r7() {
  var _a2;
  return ((_a2 = zs.get("minilang")) == null ? void 0 : _a2.name) || "m";
}
function P3(e) {
  var _a2;
  if (e.type !== "CallExpression")
  ...
  if (t.type !== "Identifier" || t.name !== r7())
    return false;
  const n = (_a2 = e.arguments) == null ? void 0 : _a2[0];
  return (n == null ? void 0 : n.type) === "Literal" && typeof n.value == "string";
}
function al(e) {
  var _a2;
  if (typeof e.start == "number")
    return e.start;
  if (P3(e)) {
    const t = (_a2 = e.arguments) == null ? void 0 : _a2[1];
    if ((t == null ? void 0 : t.type) === "Literal" && typeof t.value == "number")
      return t.value;
  }
  return 0;
}
...
function d7(e) {
  var _a2;
  return e.type === "CallExpression" && v3.includes((_a2 = e.callee.property) == null ? void 0 : _a2.name);
}
function h7(e) {
...
function lV(e = {}) {
  ...
  const { prebake: t, ...n } = e;
  return ls = PM({ ...n, transpiler: $Z }), mu = (async () => (await cV(), await (t == null ? void 0 : t()), ls))(), ar(() => ls.scheduler.now()), mu;
}
