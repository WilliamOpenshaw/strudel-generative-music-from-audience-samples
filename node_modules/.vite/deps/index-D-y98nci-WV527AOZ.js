...
// node_modules/@strudel/repl/dist/index-D-y98nci.js
var gm = {
  gm_piano: [
    //'gm_acoustic_piano': [
...
async function getFontBufferSource(v, F, c) {
  ...
  return t.playbackRate.value = p, n.loopStart > 1 && n.loopStart < n.loopEnd && (t.loop = true, t.loopStart = n.loopStart / n.sampleRate, t.loopEnd = n.loopEnd / n.sampleRate), t;
}
var bufferCache = {};
    ...
    hr(
      ...
      async (c, l, e) => {
        const [f, s, n, t] = Xs([
          ...
          l.sustain,
          l.release
        ]), { duration: i } = l, p = O4(l.n, F.length), h = F[p], S = st(), r = await getFontBufferSource(h, l, S);
        r.start(c);
        const d = S.createGain(), a = r.connect(d), u = c + i;
        Ls(a.gain, f, s, n, t, 0, 0.3, c, u, "linear");
        let o = u + t + 0.01;
        const g = co(r.detune, l, c);
        lo(r.detune, l, c, u), r.stop(o);
        const R = (U) => {
        };
        return Wr(r, () => {
          wt(r), g == null ? void 0 : g.stop(), e();
        }), { node: a, stop: R, nodes: { source: [r], ...g == null ? void 0 : g.nodes } };
      },
      { type: "soundfont", prebake: true, fonts: F }
    );
  });
}
var instruments = [
    ...
    (function(c, l) {
      ...
      return function(c) {
        ...
        function e(f) {
          ...
          var s = l[f] = { i: f, l: false, exports: {} };
          return c[f].call(s.exports, s, s.exports, e), s.l = true, s.exports;
        }
        return e.m = c, e.c = l, e.d = function(f, s, n) {
          e.o(f, s) || Object.defineProperty(f, s, { enumerable: true, get: n });
        }, e.r = function(f) {
          ...
          if (e.r(n), Object.defineProperty(n, "default", { enumerable: true, value: f }), 2 & s && typeof f != "string") for (var t in f) e.d(n, t, (function(i) {
            return f[i];
          }).bind(null, t));
          return n;
        }, e.n = function(f) {
        ...
        function(c, l, e) {
          ...
          function i(d, a) {
            for (var u = 0; u < a.length; u++) {
              var o = a[u];
              o.enumerable = o.enumerable || false, o.configurable = true, "value" in o && (o.writable = true), Object.defineProperty(d, o.key, o);
            }
          }
          function p(d) {
          ...
          var r = function(d) {
            function a(g) {
              ...
              }(this, a), U = this, R = !(L = p(a).call(this, g.id, g.length, g.buffer, g.subChunks)) || t(L) !== "object" && typeof L != "function" ? S(U) : L, A = S(S(R)), y = void 0, (b = "subChunks") in A ? Object.defineProperty(A, b, { value: y, enumerable: true, configurable: true, writable: true }) : A[b] = y, R.subChunks = g.subChunks.map(function(M) {
                return new a(M);
              }), R;
            }
            var u, o;
            return function(g, R) {
              ...
              g.prototype = Object.create(R && R.prototype, { constructor: { value: g, writable: true, configurable: true } }), R && h(g, R);
        ...
        function(c, l, e) {
          ...
          var f = e(
            ...
            for (var R = [], U = 0; U < r.length; U++) {
              for (var L = r[U], A = r[U + 1], b = L.bagIndex, y = A ? A.bagIndex : d.length, M = [], k = void 0, E = b; E < y; E++) {
                var P = p(E, d, a), O = h(E, d, u), I = O[n.GeneratorType.KeyRange] && O[n.GeneratorType.KeyRange].range, N = O[g];
                if (N) {
                  var w = o[N.value];
                  w && M.push({ keyRange: I, modulators: P, generators: O, reference: w });
                } else E - b == 0 && (k = { keyRange: I, modulators: P, generators: O });
              }
              R.push({ header: L, globalZone: k, zones: M });
            }
            return R;
          }, p = function(r, d, a) {
        ...
        function(c, l, e) {
          ...
          function n(i, p, h) {
            return p in i ? Object.defineProperty(i, p, { value: h, enumerable: true, configurable: true, writable: true }) : i[p] = h, i;
          }
          var t = function() {
            function i(S) {
        ...
        function(c, l, e) {
          ...
          function n(S) {
            ...
            return (n = function(d) {
              ...
              return u.prototype = Object.create(d.prototype, { constructor: { value: u, enumerable: false, writable: true, configurable: true } }), i(u, d);
            })(S);
          }
          function t(S, r, d) {
            return (t = function() {
          ...
          var h = function(S) {
            ...
            return function(d, a) {
              ...
              d.prototype = Object.create(a && a.prototype, { constructor: { value: d, writable: true, configurable: true } }), a && i(d, a);
            }(r, n(Error)), r;
          }();
        }
      ), "./src/riff/parser.ts": (
        ...
        function(c, l, e) {
          ...
          function n(p, h) {
            for (var S = 0; S < h.length; S++) {
              var r = h[S];
              r.enumerable = r.enumerable || false, r.configurable = true, "value" in r && (r.writable = true), Object.defineProperty(p, r.key, r);
            }
          }
          function t(p, h, S) {
            return h in p ? Object.defineProperty(p, h, { value: S, enumerable: true, configurable: true, writable: true }) : p[h] = S, p;
          }
          var i = function() {
            function p(r, d, a, u) {
              (function(o, g) {
        ...
        function(c, l, e) {
          ...
          function h(a, u) {
            for (var o = 0; o < u.length; o++) {
              var g = u[o];
              g.enumerable = g.enumerable || false, g.configurable = true, "value" in g && (g.writable = true), Object.defineProperty(a, g.key, g);
            }
          }
          function S(a, u, o) {
          ...
          function r(a, u, o) {
            return u in a ? Object.defineProperty(a, u, { value: o, enumerable: true, configurable: true, writable: true }) : a[u] = o, a;
          }
          var d = function() {
            function a(u) {
              if (function(g, R) {
              ...
              return Object(i.memoize)(function(U, L, A) {
                ...
                if (b) {
                  ...
                  if (y) {
                    ...
                    if (M) {
                      var k = M.instrument, E = k.zones.find(function(N) {
                        return o.isKeyInRange(N, U);
                      });
                      if (E) {
                        var P = E.sample, O = p({}, M.generators, E.generators), I = p({}, M.modulators, E.modulators);
                        return { keyNumber: U, preset: y, instrument: k, sample: P, generators: O, modulators: I };
                      }
                    }
                  }
                }
...
var D = (v, F, c, l, e) => {
  ...
  const r = F.generators[v], d = (s = (f = c.globalZone) == null ? void 0 : f.generators) == null ? void 0 : s[v], a = (n = l == null ? void 0 : l.generators) == null ? void 0 : n[v], u = (i = (t = e.globalZone) == null ? void 0 : t.generators) == null ? void 0 : i[v], o = r && "value" in r ? r.value : void 0, g = d && "value" in d ? d.value : void 0, R = a && "value" in a ? a.value : void 0, U = u && "value" in u ? u.value : void 0, L = (p = o ?? g) != null ? p : S, A = (h = R ?? U) != null ? h : 0;
  return L + A;
};
var J = (v) => SoundFont2Exports.DEFAULT_GENERATOR_VALUES[v] !== void 0;
var W = (v, F, c) => {
  var l, e, f, s;
...
function X(v, F, c) {
  ...
  const {
    ...
    pan: k = 0,
    ...E
  } = c, P = 100 * (d !== void 0 && d !== -1 ? d : p) + h - a, O = e * 100 - P, I = 1 * Math.pow(2, O / 1200);
  F.playbackRate.value = I;
  const N = n + u + o * 32768, w = t + g + R * 32768;
  w > N && r === 1 ? (F.loopStart = N / i, F.loopEnd = w / i, F.loop = true) : r === 3 && console.warn("unimplemented sampleMode 3 (play till end on note off)"), Object.keys(E).filter(
  ...
  return H.pan.value = k / 1e3, B.connect(H), F.connect(B), H.connect(v.destination), F.start(l), (V = v.currentTime) => {
    F.stop(V + m(M)), Z(V);
  };
}
function Y(v, F, c = {}) {
...
var C = (v, F) => !v.keyRange || v.keyRange.lo <= F && F <= v.keyRange.hi;
var x = (v, F) => v.zones.filter((c) => C(c, F) && c.instrument).map((c) => c.instrument.zones.filter((l) => C(l, F)).map((l) => {
  const e = W(l, c, v);
  return {
    ...l,
    mergedGenerators: e
...
fe.prototype.soundfont = function(v, F = 0) {
  return this.onTrigger((c, l, e, f) => {
    const s = st(), n = w4(c), t = v.presets[F % v.presets.length], i = f, p = [s, t, yr(n), i];
    ce(...p)(i + c.duration);
  });
};
...
//# sourceMappingURL=index-D-y98nci-WV527AOZ.js.map
